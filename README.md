...
- **Content Split:** Netflix's catalog skews more heavily toward Movies than TV Shows.
- **Common Ratings:** TV-MA and TV-14 dominate — most content targets mature audiences.
- **Top Countries:** The United States leads in content volume, followed by India and the UK.
- **India Trends:** India's content peaked in specific years, signaling strategic investment periods.
- **Genre Breakdown:** International Movies, Dramas, and Comedies are the most listed genres.
- **Content Safety:** A notable share of content references violence or harmful language in descriptions.

---

## Setup & Usage

**Prerequisites:** PostgreSQL (v12+)

```bash
# 1. Clone the repository
git clone https://github.com/dikshita168/Netflix_SQL_Project.git
cd Netflix_SQL_Project

# 2. Create the database
psql -U postgres -c "CREATE DATABASE netflix_db;"

# 3. Run the schema and data load
psql -U postgres -d netflix_db -f schema.sql

# 4. Run the analysis queries
psql -U postgres -d netflix_db -f solutions.sql
```
...
├── solutions.sql       # All 15 business problem queries
...
**Dikshita Pawar** · [@dikshita168](https://github.com/dikshita168)
